...
def load_args():
    ...
    parser.add_argument('out', help='output folder '
                                    'to place plots')
    parser.add_argument('--sim', help='path to binary file or '
                                    'text dir for simulated seismograms')
    parser.add_argument('--obs', help='path to text dir '
                                    'for observed seismograms')
    parser.add_argument('--sim-prefix', default='',
                        help='sim text files '
                             'are named <prefix>station.comp')
    parser.add_argument('--obs-prefix', default='',
                        help='obs text files are named <prefix>station.comp')
    parser.add_argument('--n_stations', default=-1,
                        help='Number of stations, selected randomly, to plot. '
                             'Default is all (-1)',
                        type=int)
    parser.add_argument('-v', help='verbose messages', action='store_true')
    parser.add_argument('-n', '--nproc', help='number of processes to use',
                        type=int, default=1)
    parser.add_argument('-t', '--tmax', type=float, help='maximun duration of '
                                                         'waveform simulation')
