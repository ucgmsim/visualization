...
For *scenario_im_faults* however you will want to create the same directory layout as *scenario_data* except in each model directory you will want to create a plots folder to place the plots in.
...
## Scenario Data
Data for scenarios is generated by running the **summarise_all_rels_im.py** script foudn in the IM_calculation repository.
...
The **summarise_all_rels_im.py** takes the following options
```shell script
usage: summarise_all_rels_im.py
                      csv_path faults im output

positional arguments:
  csv_path              Full file path to the IM csv directory for the given model
  faults                Faults to extract from the IM CSV's

optional arguments:
  --im                  IM's to extract from the IM CSV's
  --output              Output directory for the scenario fault files
  --median              Find median (default: mean) (Not needed to be set for scenario data)
```

#### Example:
```shell script
python ../IM_calculation/scripts/summarise_all_rels_im.py /isilon/CS_IMs/v21p6_im -faults Port2GreyL HopeConwayOS --im PGV PGA pSA_0.1 pSA_1.0 pSA_5.0 --output ../scenarios/scenarios_data/21p6
```
...
usage: scenario_im_fault.py [--model]
                      config_ffp scenario_data_ffp output_dir
...
#### Example
```shell script
python ../scenario_im_faults.py -config_ffp ../visualization/cybershake/scenario_ratios_config.yaml -scenario_data_ffp ../scenarios/scenarios_data -output_dir ../scenarios/scenario_im_faults --model 21p1_21p6
```
...
#### Example
```shell script
python ../scenario_im_faults.py -config_ffp ../visualization/cybershake/scenario_ratios_config.yaml -scenario_data_ffp ../scenarios/scenarios_data -output_dir ../scenarios/scenario_im_faults
```
...
#### Example
```shell script
python ../scenario_epsilon.py -config_ffp ../visualization/cybershake/scenario_ratios_config.yaml -scenario_data_ffp ../scenarios/scenarios_data -output_dir ../scenarios/scenario_im_faults
```