...
SLURM = 'im_plot.sl'
SIM_REPO = '/nesi/nobackup/nesi00213/RunFolder/Cybershake/v18p6/Runs/test/Kelly/IM_calc'
LL_PATH = '/nesi/transit/nesi00213/StationInfo/non_uniform_whole_nz_with_real_stations-hh400_v18p6.ll'
PLOT_REPO = '/nesi/nobackup/nesi00213/RunFolder/Cybershake/v18p6/Runs/test/Kelly/IM_plot'


def plot_im(sim_repo=SIM_REPO, plot_repo=PLOT_REPO):
	...
	print(sim_repo, dire_path)
        info = glob.glob1(dire_path, '*.info')[0]
        print("info", info)
	...
	print("info path", info_path)
        ...
        for xyz in xyz_files:
            ...
            cmd = 'python ~/visualization/gmt/plot_stations.py {} --out_dir {}'.format(xyz_path, xyz_plot_dir)
            subprocess.call(cmd, shell=True)
