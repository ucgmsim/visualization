...
OUTPUT_NONUNI_SIM_XYZ = os.path.join(OUTPUT_DIR, 'nonuniform_im_plot_map_kelly_sim_sim.xyz')
OUTPUT_NONUNI_OBS_XYZ = os.path.join(OUTPUT_DIR, 'nonuniform_im_plot_map_kelly_obs_obs.xyz')
OUTPUT_NONUNI_EMP_XYZ = os.path.join(OUTPUT_DIR, 'nonuniform_im_plot_map_kelly_emp_empirical.xyz')
...
BENCHMARK_NONUNI_OBS_XYZ = os.path.join(INPUT_DIR, 'nonuniform_im_plot_map_kelly_obs_obs.xyz')
BENCHMARK_NONUNI_SIM_XYZ = os.path.join(INPUT_DIR, 'nonuniform_im_plot_map_kelly_sim_sim.xyz')
BENCHMARK_NONUNI_EMP_XYZ = os.path.join(INPUT_DIR, 'nonuniform_im_plot_map_kelly_emp_empirical.xyz')
...
@pytest.mark.parametrize("input_file, output_file1, output_file2, benchmark1, benchmark2", [(INPUT_OBS, OUTPUT_OBS_XYZ, OUTPUT_NONUNI_OBS_XYZ, BENCHMARK_OBS_XYZ, BENCHMARK_NONUNI_OBS_XYZ), (INPUT_SIM, OUTPUT_SIM_XYZ, OUTPUT_NONUNI_SIM_XYZ, BENCHMARK_SIM_XYZ, BENCHMARK_NONUNI_SIM_XYZ), (INPUT_EMP, OUTPUT_EMP_XYZ, OUTPUT_NONUNI_EMP_XYZ, BENCHMARK_EMP_XYZ, BENCHMARK_NONUNI_EMP_XYZ), ])
